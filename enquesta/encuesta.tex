...
\begin{enumerate}
\item \stepcounter{preg} Centro al que pertenece:
\item \stepcounter{preg} Categoría profesional:
\item \stepcounter{preg} Género:
...
\begin{enumerate}
\stepcounter{preg}
\item \stepcounter{preg} Participas en la docencia de prácticas con ordenador?
   \begin{itemize}
   \item Sí.
   \item No.
...
\item \stepcounter{preg} Los programas que se usan en esas prácticas ¿son software libre?
      \begin{itemize}
      \item Sí.
      \item No.
      \end{itemize}

\item \stepcounter{preg} ¿Los y las estudiantes tienen facilidad para instalar dichos programas en sus ordenadores?
      \begin{itemize}
      \item Sí.
      \item No.
...
\item \stepcounter{preg} ¿Podrías decir cuáles son los principales programas utilizados en las prácticas con ordenador?
   \vspace*{1cm}

\item \stepcounter{preg} ¿Las aulas de informática disponen de ese software instalado?
      \begin{itemize}
...
\item \stepcounter{preg} Comenta brevemente qué incidencias has tenido con estos programas, si ha habido alguna.
\vspace*{1cm}
\end{enumerate}
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} ¿Tienes conocimiento de algún lenguaje de programación?
   \begin{itemize}
   \item Sí.
   \item No.
   \end{itemize}
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} ¿Conoces y utilizas el entorno RStudio \cite{RStudio}?
   \begin{itemize}
...
\item \stepcounter{preg} Si lo haces, ¿conoces y utilizas los documentos dinámicos de tipo Rmarkdown?
   \begin{itemize}
...
\item \stepcounter{preg} ¿Crees que la UV debería ofrecer un servidor de RStudio para su uso remoto en la docencia,
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} ¿Conoces y utilizas el entorno Jupyter (Jupyter notebooks o Jupyter lab) \cite{Barba2019}?
   \begin{itemize}
   \item Sí, lo conozco, pero no lo utilizo.
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} ¿Qué ventajas crees que tendría sustituir una aplicación de interfaz gráfica
...
\item \stepcounter{preg} ¿Qué desventajas o dificultades conllevaría sustituir una aplicación de interfaz gráfica por un
...
\item \stepcounter{preg} ¿Te gustaría recibir información sobre cómo aplicar los lenguajes de programación a la
      docencia?
   \begin{itemize}
   \item Sí.
   \item No.
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} ¿Conoces algún sistema de control de versiones (e.g., \textsf{git}, Subversion, Mercurial) y
      para qué sirven?
   \begin{itemize}
...
\item \stepcounter{preg} Siendo los materiales docentes documentos generalmente compartidos y actualizados con cierta
...
\item \stepcounter{preg} ¿Crees que mantener colectivamente los materiales docentes bajo un sistema de control de
...
\item \stepcounter{preg} ¿Estarías dispuesto o dispuesta a recibir formación sobre el uso de un sistema de control de
...
\item \stepcounter{preg} ¿Crees que la UV debería tener su propio servidor de repositorios de \textsf{git}, como un
...
\stepcounter{preg}
\begin{enumerate}
\item \stepcounter{preg} En algunas asignaturas se usan o podrían usarse bases de datos grandes y/o una intensidad de
...
\item \stepcounter{preg} Si es así, ¿puedes concretar qué recurso sería más accesible a través de un servidor de 
      cálculo remoto?
\vspace*{1cm}
\end{enumerate}
